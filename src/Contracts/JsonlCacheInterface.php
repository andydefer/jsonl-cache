...
namespace AndyDefer\JsonlCache\Contracts;

use AndyDefer\JsonlCache\Records\CacheRecord;

/**
 * PSR-16 compatible cache interface with JSONL storage.
 */
interface JsonlCacheInterface
{
    /**
    ...
    /**
     * Gets the CacheRecord for a key.
     *
     * @param  string  $key  The cache key.
     * @return CacheRecord|null The cache record or null if not found.
     */
